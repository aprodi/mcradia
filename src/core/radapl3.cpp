...
void radTApplication::ComputeFocusKickPer(int ElemKey, double* P1, double* Nlong, double per, int nper, double* N1, double r1, int np1, double r2, int np2, const char* StrComment, int nharm, int ns, double d1, double d2)
{
