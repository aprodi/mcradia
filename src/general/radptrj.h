...
public:
	...
	radTPrtclTrj(radTg3d* InFldSourcePtr, const radTCompCriterium& InCompCrit) // For Focusing Potential
	{
	...
	static void ComposeStrReportSecondOrderKickPer(const char* StrComment, double len, int np1, int np2, double* pCoordDir1, double* pCoordDir2, double* pKickData1, double* pKickData2, double* pBtE2Int, char*& StrReport);
//#ifdef __GCC__
