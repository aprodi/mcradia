...
* Project:        RADIA
*
* Description:    C-stype interface, used by Mathematica (Mathlink)
*
...
{
	const char *funName;
	int numPar01 = 0, numPar02 = 0, readOK = 0; //, next = 0;
...
//Hi: k or {kx,ky} or {{kx,ky},phi}
	...
	{//Assuming {{mx1,my1,mz1},{mx2,my2,mz2},...} or {mx1,my1,mz1}
...
void FocusingKickPer(int ElemKey, double x1, double y1, double z1, double nsx, double nsy, double nsz, double per, int nper, double n1x, double n1y, double n1z, double r1, int np1, double r2, int np2, const char* Comment, int nharm, int ns, double d1, double d2)
{
	...
	rad.ComputeFocusKickPer(ElemKey, P1, Nlong, per, nper, N1, r1, np1, r2, np2, Comment, nharm, ns, d1, d2);
}
