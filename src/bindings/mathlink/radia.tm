...
:Evaluate:      radUtiDmp::usage = "radUtiDmp[elem] gives information on the element elem."
...
:Pattern:       radFldFocKickPer[ElemKey_,{x0_,y0_,z0_},{nsx_,nsy_,nsz_},per_,nper_,{n1x_,n1y_,n1z_},r1_,np1_,r2_,np2_,comment_String:"",{nh_:1,ns_:8,d1_:0,d2_:0}]
:Arguments:     { Round[ElemKey], N[x0],N[y0],N[z0], N[nsx],N[nsy],N[nsz], N[per],Round[nper], N[n1x],N[n1y],N[n1z], N[r1],Round[np1],N[r2],Round[np2], comment, Round[nh],Round[ns],N[d1],N[d2] }
:ArgumentTypes: { Integer, Real,Real,Real, Real,Real,Real, Real,Integer, Real,Real,Real, Real,Integer,Real,Integer, String, Integer,Integer,Real,Real}
:ReturnType:    Manual
:End:
