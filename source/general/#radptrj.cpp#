...
void radTPrtclTrj::ComposeStrReportSecondOrderKickPer(const char* StrComment, double UndLen, int np1, int np2, double* pCoordDir1, double* pCoordDir2, double* pKickData1, double* pKickData2, double* pBtE2Int, char*& pStrReport)
